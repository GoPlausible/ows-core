...
console.log(wallet.accounts); // addresses for EVM, Solana, Bitcoin, Cosmos, Tron, TON, Filecoin, Sui, and Algorand
...
| `ows-signer` | ChainSigner trait, HD derivation, address derivation for EVM, Solana, Sui, Bitcoin, Cosmos, Tron, TON, Spark, Filecoin, and Algorand (AVM). |
...
- **Algorand (AVM)** — Ed25519 (BIP32-Ed25519 Peikert g=9), base32 58-char addresses
