...
impl ChainSigner for AlgorandSigner {
...
mod tests {
    ...
    fn test_chain_properties() {
        let signer = AlgorandSigner;
        assert_eq!(signer.chain_type(), ChainType::Algorand);
    ...
    fn test_address_encoding() {
        ...
        let address = AlgorandSigner::encode_address(&pubkey_bytes);
