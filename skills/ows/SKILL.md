---
name: ows
description: Secure, local-first multi-chain wallet management — create wallets, derive addresses, sign messages and transactions across EVM, Solana, Sui, Bitcoin, Cosmos, Tron, TON, Spark, Filecoin, and Algorand (AVM) via CLI, Node.js, or Python.
version: 1.1.0
metadata:
  openclaw:
    requires:
